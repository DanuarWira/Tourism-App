package com.example.tourism_app.data.source
...
class DestinationDataSource {
    ...
    val destinations = dataMaps.map {
        Destination(
            name = it["name"] as String,
            location = it["location"] as String,
            description = it["description"] as String,
            rating = it["rating"] as Double,
            image = it["image"] as Int,
            price = it["price"] as Int,
            timeElapse = it["timeElapse"] as Int,
